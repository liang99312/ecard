 ...
 * @author Jane
 */
public class EcardHkPanel extends javax.swing.JPanel {
    ...
    private String order_sql = "e.ecard_code,e.ru_date";
    ...
    private void initOthers() {
        ...
        ftable = new FTable(Ecard_ru.class, true, true, true, "EcardHkPanel");
        List<TempFieldInfo> shift_infos = EntityBuilder.getCommFieldInfoListOf(Ecard_ru.class, EntityBuilder.COMM_FIELD_VISIBLE);
        for (TempFieldInfo tfi : shift_infos) {
            default_infos.add(tfi);
            all_infos.add(tfi);
        }
        ftable.setAll_fields(all_infos, default_infos, default_orders, "EcardHkPanel");
        order_sql = SysUtil.getSQLOrderString(ftable.getCurOrderScheme(), order_sql, all_infos);
        ftable.setRight_allow_flag(true);
        pnlTable.add(ftable);

        pnlBeanRu.add(new JScrollPane(beanPanel));
    ...
    private void setupEvents() {
        ...
        ftable.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                CommEditAction.doRowSaveAction(curEcard_ru, editable);
                if (curEcard_ru == ftable.getCurrentRow()) {
                    return;
                }
                curEcard_ru = ftable.getCurrentRow();
        ...
        ftable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() >= 2) {
                    ...
                    EditBeanPanel pnl = new EditBeanPanel(curEcard_ru);
                    ModelFrame mf = ModelFrame.showModel(ContextManager.getMainFrame(), pnl, true, "编辑汇款信息", 650, 500, false);
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                CalcEcardRuPanel pnl = new CalcEcardRuPanel("hk");
                ModelFrame mf = ModelFrame.showModel(ContextManager.getMainFrame(), pnl, true, "生成汇款数据", 380, 220, false);
                mf.addIPickWindowCloseListener(new IPickWindowCloseListener() {
    ...
    private void fetchData(QueryScheme qs) {
        if (curTreeNode instanceof DefaultMutableTreeNode) {
            ...
            String sql = " from Ecard_ru e where 1=1";
            sql = sql + " and ru_ym >='" + ym_from + "' and ru_ym<='" + ym_to + "'";
            if (qs != null) {
                sql += " and e.ecard_ru_key in(" + qs.buildSql() + ")";
            }
            sql += where_sql;
            sum_sql = sql;
            sql = "select ecard_ru_key" + sql + " order by " + order_sql;
            PublicUtil.getProps_value().setProperty(Ecard_ru.class.getName(), "from Ecard_ru e where e.ecard_ru_key in");
    ...
    private void initComponents() {
        ...
        pnlBeanRu = new javax.swing.JPanel();
        ...
        pnlBeanRu.setLayout(new java.awt.BorderLayout());
        jTabbedPane1.addTab("汇款信息", pnlBeanRu);
    ...
    private javax.swing.JPanel pnlBeanRu;
