 ...
 */
public class AddEposPanel extends javax.swing.JPanel {
    ...
    private void initOthers() {
        ...
        epos = (Epos) UtilTool.createUIDEntity(Epos.class);
        beanPanel.setBean(epos);
    ...
    private void setupEvents() {
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ValidateSQLResult result = CommUtil.saveEntity(epos);
